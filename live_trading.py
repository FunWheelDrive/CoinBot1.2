...
# CoinEx futures market pairs (top 15)
coinex_pairs = {
    "BTCUSDT": "BTC/USDT",
    "ETHUSDT": "ETH/USDT",
    "BNBUSDT": "BNB/USDT",
...
# Initialize CoinEx exchange for futures
exchange = ccxt.coinex({
    'apiKey': COINEX_API_KEY,
    'secret': COINEX_API_SECRET,
    'enableRateLimit': True,
    'options': {
        'defaultType': 'future'  # Explicitly set to futures market
    }
})
...
def place_market_order(symbol, action, volume):
    """Place a market order on CoinEx futures market."""
    try:
